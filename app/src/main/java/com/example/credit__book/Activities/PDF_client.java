...
public class PDF_client extends AppCompatActivity {
...
//    String storagePermission[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdf_client);
...
//        storagePermission=new String[] {Manifest.permission.WRITE_EXTERNAL_STORAGE};
        ...
        nam = getIntent().getStringExtra("Client Name");
        ...
        DatabaseReference db = dbRef.getReference("OperationsClients").child(Objects.requireNonNull(new SessionManager(this).getUserDetails().get(SessionManager.TELEPHONE)));
...
//                        }
    ...
    private void createPdf(Bitmap bitmap) {
        ...
        File filepath=new File(this.getExternalFilesDir(null),"client.pdf");
        try {
    ...
    private void openPdf() {
        File file=new File(this.getExternalFilesDir(null),"/client.pdf");
